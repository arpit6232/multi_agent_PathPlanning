"""
Python implementation of conflict based searh 
"""
...
class EdgeConstraint(object):
    ...
    def __hash__(self):
        return hasj(str(self.time) + str(self.location_1) + str(self.location_2))
...
class Environment(object):
    ...
    def __init__(self, dimension, agents, obsctacles):
        self.dimension = dimension
        self.obsctacles = obsctacles
    ...
    def compute_solution(self):
        ...
        for agent in self.agent_dict.keys():
            ...
            local_solution = self.a_star.searh(agent)
